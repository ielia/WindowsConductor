...
reportgenerator -reports:"coverage-results/*/coverage.cobertura.xml" -targetdir:coverage-report -reporttypes:"TextSummary;Html" -filefilters:"-*\obj\*" -verbosity:Warning
