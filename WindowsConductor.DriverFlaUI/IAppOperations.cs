...
internal interface IAppOperations
{
    ...
    string WaitForElement(string appId, string[] selectors, string? rootElementId, uint timeout, CancellationToken ct = default);
    ...
    void GlobalHitKeys(string[] keys);
    void GlobalTypeText(string text, int modifiers = 0);
